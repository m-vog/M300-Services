...
##### Laura Weber
Zu Beginn wollten wir diese LB mit Kubernetes durchführen. Nach einigen Stunden Troubleshooting mit einigen Containern, haben wir uns aber dafür entschieden Docker zu verwenden. Ich habe im Wahlmodul W906 bereits mit Kubernetes gearbeitet. Docker hatte ich noch nie verwendet, jedoch habe ich schnell den Einstieg gefunden. Leider hatte ich während des Moduls immer wieder Probleme mit der Hardware und Software. Ich musste einen neuen Laptop kaufen, da der alte den Geist aufgegeben hatte. Auch mit Git hatte ich Schwierigkeiten, der SSH-Key den ich hinterlegt hatte, funktionierte zwar, jedoch startete der SSH-Key-Agent oft nicht, oder war sogar ganz verschwunden. Das Modul war ziemlich anspruchsvoll, dafür konnte ich vieles lernen.
##### Marc Vogelmann
